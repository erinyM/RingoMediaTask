...
namespace WebApplication1.Controllers
{
    public class RemindersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReminderDateTime,IsNotified")] Reminder reminder)
        {
            if (id != reminder.Id)
            {
                return NotFound();
        ...
        // Other actions (Index, Details, Create, Edit) go here
    }
